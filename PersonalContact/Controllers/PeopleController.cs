...
namespace PersonalContact.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Gender"] = new SelectList(lstGender);
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,DOB,Gender")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,DOB,Gender")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
